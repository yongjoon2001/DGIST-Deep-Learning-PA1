...
def plot_confusion_matrix(model, test_loader, save_path):
    ...
    plt.title('Confusion Matrix (PyTorch)', fontsize=15, weight='bold', pad=15)
...
def main():
    ...
    print("Training 3-layer Neural Network (PyTorch)...")
    train_model(model, train_loader, test_loader, epochs=15, learning_rate=0.001)
